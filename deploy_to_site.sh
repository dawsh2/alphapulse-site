...
# Script to deploy alphapulse-web to alphapulse-site and push to GitHub
...
if [ ! -d "/Users/daws/alphapulse/alphapulse-web" ]; then
    echo "❌ Error: Source directory /Users/daws/alphapulse/alphapulse-web not found"
    exit 1
fi
...
echo "📂 Copying new files from alphapulse-web..."
cp -r /Users/daws/alphapulse/alphapulse-web/* .
